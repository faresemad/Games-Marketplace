    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('Buyer', 'BUYER'), ('Seller', 'SELLER'), ('Support', 'SUPPORT'), ('Admin', 'ADMIN'), ('Pending Seller', 'PENDING_SELLER'), ('Rejected Seller', 'REJECTED_SELLER'), ('Suspended', 'SUSPENDED')], default='Buyer', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-changed_at'],
                'indexes': [models.Index(fields=['user', '-changed_at'], name='users_email_user_id_62a6bc_idx')],
            },
        ),
    ]
